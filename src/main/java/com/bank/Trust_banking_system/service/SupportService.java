...
public class SupportService {
    ...
    public SupportTicket createTicket(TicketRequest request) {
        ...
        emailService.sendMail(user.getEmail(), "Ticket Created", body);
    ...
    public SupportTicket updateStatus(Long ticketId, String status) {
        ...
        emailService.sendMail(user.getEmail(), "Ticket Status Updated", body);
        ...
        if ("RESOLVED".equalsIgnoreCase(status)) {
            ...
            emailService.sendMail(
                    ...
                    "Your ticket has been resolved. Thank you!"
    ...
    public TicketComment addComment(CommentRequest request) {
        ...
        emailService.sendMail(
                ...
                "New comment: " + saved.getCommentText()
